...
for (const [page, prefix] of [['index.html',''], ...productSlugs.map(slug=>[`products/${slug}/index.html`,'../../'])]) {
  ...
  for (const asset of ['mobile-previews.js?v=1.0.0', 'templates/product-training/mobile-training.js?v=1.0.4', 'templates/product-training/mobile-training.css?v=1.0.7']) {
