...
window.MM3A_DATA = (() => {
  ...
  return {
    ...
    portal: {
      ...
      support: {
        contentsImage: 'assets/support/mm3a-package-contents.jpg', packageImage: 'assets/support/mm3a-package-contents.jpg',
        imageAlt: { en: 'MM3A speaker pair with foam pads, supplied cables and printed guides', zh: 'MM3A 音箱一对、泡棉垫、随附线材及纸质说明资料' },
        en: { contents: ['MM3A master / partner speaker pair','Z-DIN4 speaker interconnect','Power cord','USB cable','AUX cable','Foam pads','User manual and quick-reference card','Certificate of conformity'], packageNote: 'MM3A speakers and supplied accessories. Refer to the list for package contents.', periods: [['MM3A main unit','1 year'],['Packaged accessories','90 days']], policy: 'The training guide specifies repair coverage for non-human-induced performance failures within the warranty period. Confirm the applicable terms with the purchase region and sales channel.', exclusions: ['Confirm the purchase date, symptom, and connection setup first.', 'Check for accidental damage, unsuitable voltage, or unauthorized repair before promising coverage.', 'Follow the local channel service process. Do not promise an automatic replacement.'] },
        zh: { contents: ['MM3A 主箱 / 副箱一对','Z-DIN4 主副箱连接线','电源线','USB 线','AUX 线','泡棉垫','用户手册与快速指引卡','合格证'], packageNote: 'MM3A 音箱及随附配件实拍，包装内容见清单。', periods: [['MM3A 主机','1 年'],['包装配件','90 天']], policy: '培训材料规定，保修期内非人为性能故障提供维修服务。具体适用条款需向购买地区及销售渠道确认。', exclusions: ['先确认购买日期、故障现象与连接方式。','遇到意外损坏、不适当电压或未经授权的拆修，先确认适用政策，不直接承诺保修。','按当地渠道售后流程处理，不承诺自动换新。'] }
      },
      reviews: [
